...
class NetworkBrandCommunicationContentAdmin extends AbstractAdmin
{
    private $image = null;
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        /**
         * @var NetworkBrandCommunicationContent $object
         */
    ...
    /**
     * @param NetworkBrandCommunicationContent $object
     * @throws \Exception
     */
