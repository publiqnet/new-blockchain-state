...
class ArticleSocialImageCommand extends ContainerAwareCommand
{
    use LockableTrait;

    protected static $defaultName = 'state:article-social-images';
    ...
    {
        $this->setDescription('Create social images for articles');
    }
